...
public abstract class Utils {
    ...
    public static ChartPointF getPosition(ChartPointF center, float dist, float angle) {
    ...
    public static void getPosition(ChartPointF center, float dist, float angle, ChartPointF outputPoint) {
    ...
    public static void drawImage(Canvas canvas,
        ...
        ChartPointF drawOffset = ChartPointF.getInstance();
    ...
    public static void drawXAxisValue(Canvas c, String text, float x, float y,
                                      Paint paint,
                                      ChartPointF anchor, float angleDegrees) {
