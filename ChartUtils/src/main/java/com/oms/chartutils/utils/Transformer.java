...
import com.oms.chartutils.interfaces.datasets.ICandleDataSet;
...
public class Transformer {
    ...
    public ChartPointD getValuesByTouchPoint(float x, float y) {
    ...
    public void getValuesByTouchPoint(float x, float y, ChartPointD outputPoint) {
    ...
    public ChartPointD getPixelForValues(float x, float y) {
        ...
        return ChartPointD.getInstance(xPx, yPx);
    }
