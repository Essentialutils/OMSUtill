...
import com.oms.chartutils.listener.PieRadarChartTouchListener;
...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>>
                ...
                case VERTICAL: {
                    ...
                    if (mLegend.getHorizontalAlignment() == Legend.LegendHorizontalAlignment.LEFT
                        ...
                        if (mLegend.getVerticalAlignment() == Legend.LegendVerticalAlignment.CENTER) {
                            ...
                            ChartPointF reference = getPosition(center, getRadius(),
                            ...
                            ChartPointF.recycleInstance(reference);
                        }
                    }
    ...
    public ChartPointF getPosition(ChartPointF center, float dist, float angle) {
    ...
    public void getPosition(ChartPointF center, float dist, float angle, ChartPointF outputPoint) {
