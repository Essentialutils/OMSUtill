...
import com.oms.chartutils.data.PieData;
import com.oms.chartutils.highlight.Highlight;
import com.oms.chartutils.highlight.PieHighlighter;
import com.oms.chartutils.interfaces.datasets.IPieDataSet;
import com.oms.chartutils.renderer.PieChartRenderer;
...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    private final ChartPointF mCenterTextOffset = ChartPointF.getInstance(0, 0);
    ...
    public void calculateOffsets() {
        ...
        ChartPointF c = getCenterOffsets();
    ...
    protected float[] getMarkerPosition(Highlight highlight) {
        ...
        ChartPointF center = getCenterCircleBox();
        float r = getRadius();
    ...
    public ChartPointF getCenterCircleBox() {
        return ChartPointF.getInstance(mCircleBox.centerX(), mCircleBox.centerY());
    }
    ...
    public ChartPointF getCenterTextOffset() {
        return ChartPointF.getInstance(mCenterTextOffset.x, mCenterTextOffset.y);
    }
