...
public class PieChartRenderer extends DataRenderer {
    ...
    protected void drawDataSet(Canvas c, IPieDataSet dataSet) {
        ...
        final ChartPointF center = mChart.getCenterCircleBox();
    ...
    public void drawValues(Canvas c) {
        ...
        ChartPointF center = mChart.getCenterCircleBox();
    ...
    protected void drawCenterText(Canvas c) {
        ...
        if (mChart.isDrawCenterTextEnabled() && centerText != null) {
            ...
            ChartPointF center = mChart.getCenterCircleBox();
            ChartPointF offset = mChart.getCenterTextOffset();
            ...
            ChartPointF.recycleInstance(center);
            ChartPointF.recycleInstance(offset);
        }
    }
