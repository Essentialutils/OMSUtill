...
import com.oms.chartutils.components.YAxis.YAxisLabelPosition;
...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void computeAxis(float yMin, float yMax, boolean inverted) {
        ...
        if (mViewPortHandler.contentHeight() > 10 && !mViewPortHandler.isFullyZoomedOutX()) {
            ...
            ChartPointD p1 = mTrans.getValuesByTouchPoint(mViewPortHandler.contentLeft(),
                    mViewPortHandler.contentTop());
            ChartPointD p2 = mTrans.getValuesByTouchPoint(mViewPortHandler.contentRight(),
                    mViewPortHandler.contentTop());
    ...
    protected void drawZeroLine(Canvas c) {
        ...
        ChartPointD pos = mTrans.getPixelForValues(0f, 0f);
