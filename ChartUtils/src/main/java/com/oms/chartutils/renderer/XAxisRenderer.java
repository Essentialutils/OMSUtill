...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void computeAxis(float min, float max, boolean inverted) {
        ...
        if (mViewPortHandler.contentWidth() > 10 && !mViewPortHandler.isFullyZoomedOutX()) {
            ...
            ChartPointD p1 = mTrans.getValuesByTouchPoint(mViewPortHandler.contentLeft(), mViewPortHandler.contentTop());
            ChartPointD p2 = mTrans.getValuesByTouchPoint(mViewPortHandler.contentRight(), mViewPortHandler.contentTop());
            ...
            ChartPointD.recycleInstance(p1);
            ChartPointD.recycleInstance(p2);
        }
    ...
    public void renderAxisLabels(Canvas c) {
        ...
        ChartPointF pointF = ChartPointF.getInstance(0, 0);
        ...
        ChartPointF.recycleInstance(pointF);
    }
    ...
    protected void drawLabels(Canvas c, float pos, ChartPointF anchor) {
    ...
    protected void drawLabel(Canvas c, String formattedLabel, float x, float y, ChartPointF anchor, float angleDegrees) {
