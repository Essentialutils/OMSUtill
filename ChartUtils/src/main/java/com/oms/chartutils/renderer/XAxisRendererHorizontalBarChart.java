...
import com.oms.chartutils.charts.BarChart;
...
public class XAxisRendererHorizontalBarChart extends XAxisRenderer {
    ...
    public void computeAxis(float min, float max, boolean inverted) {
        ...
        if (mViewPortHandler.contentWidth() > 10 && !mViewPortHandler.isFullyZoomedOutY()) {
            ...
            ChartPointD p1 = mTrans.getValuesByTouchPoint(mViewPortHandler.contentLeft(), mViewPortHandler.contentBottom());
            ChartPointD p2 = mTrans.getValuesByTouchPoint(mViewPortHandler.contentLeft(), mViewPortHandler.contentTop());
