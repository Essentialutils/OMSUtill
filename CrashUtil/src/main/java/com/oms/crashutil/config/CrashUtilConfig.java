package com.oms.crashutil.config;
...
import com.oms.crashutil.CustomActivityOnCrash;
...
public class CrashUtilConfig implements Serializable {
    ...
    public static class Builder {
        private CrashUtilConfig config;

        @NonNull
        public static Builder create() {
            Builder builder = new Builder();
            CrashUtilConfig currentConfig = CustomActivityOnCrash.getConfig();

            CrashUtilConfig config = new CrashUtilConfig();
