package com.oms.utill.status_bar;
...
public class CustomStatusBar {
    ...
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.custombtatusbar_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.custombtatusbar_translucent_view;
